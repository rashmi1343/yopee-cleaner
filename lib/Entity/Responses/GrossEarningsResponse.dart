...
// //
// //     final grossEarningsResponse = grossEarningsResponseFromJson(jsonString);
//
// import 'dart:convert';
//
// GrossEarningsResponse grossEarningsResponseFromJson(String str) =>
//     GrossEarningsResponse.fromJson(json.decode(str));
//
// String grossEarningsResponseToJson(GrossEarningsResponse data) =>
//     json.encode(data.toJson());
//
// class GrossEarningsResponse {
//   String? message;
//   int? status;
//   GrossEarningsData data;
//
//   GrossEarningsResponse({
//     this.message,
//     this.status,
//     required this.data,
//   });
//
//   factory GrossEarningsResponse.fromJson(Map<String, dynamic> json) =>
//       GrossEarningsResponse(
//         message: json["message"],
//         status: json["status"],
//         data: GrossEarningsData.fromJson(json["data"]),
//       );
//
...
// }
//
// class GrossEarningsData {
//   int totalGrassEarning;
//   List<Transcation> transcations;
//
//   GrossEarningsData({
//     required this.totalGrassEarning,
//     required this.transcations,
//   });
//
//   factory GrossEarningsData.fromJson(Map<String, dynamic> json) =>
//       GrossEarningsData(
//         totalGrassEarning: json["totalGrassEarning"] ?? 0,
...
//
//   Map<String, dynamic> toJson() => {
//         "totalGrassEarning": totalGrassEarning,
//         "transcations":
//             List<dynamic>.from(transcations!.map((x) => x.toJson())),
//       };
// }
//
// class Transcation {
...
// To parse this JSON data, do
//
//     final grossEarningResponse = grossEarningResponseFromJson(jsonString);
...
class GrossEarningsData {
  ...
  factory GrossEarningsData.fromJson(Map<String, dynamic> json) =>
      GrossEarningsData(
        totalGrassEarning: json["totalGrassEarning"],
        transcations: json["transcations"] == null
            ? []
            : List<Transcation>.from(
                json["transcations"]!.map((x) => Transcation.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        "totalGrassEarning": totalGrassEarning,
        "transcations": transcations == null
            ? []
            : List<dynamic>.from(transcations!.map((x) => x.toJson())),
      };
}
...
class Transcation {
  ...
  UserVehicle userVehicle;
  User user;
  GrossEarningUserAddress userAddress;
  ...
  factory Transcation.fromJson(Map<String, dynamic> json) => Transcation(
        ...
        user: User.fromJson(json["user"] ?? {}),
        userAddress:
            GrossEarningUserAddress.fromJson(json["user_address"] ?? {}),
      );
...
class GrossEarningUserAddress {
  ...
  factory GrossEarningUserAddress.fromJson(Map<String, dynamic> json) =>
      GrossEarningUserAddress(
        id: json["id"],
        userId: json["user_id"],
        type: json["type"],
