...
class EarningsData {
  ...
  int? totalRemaining;
  int? rejectedPayment;
  int? totalMonthlySubscribtion;
  int? totalOneTimeService;
  ...
  EarningsData({
    ...
    this.totalMonthlySubscribtion,
    this.totalOneTimeService,
  ...
  factory EarningsData.fromJson(Map<String, dynamic> json) => EarningsData(
        ...
        rejectedPayment: json["RejectedPayment"],
        totalMonthlySubscribtion: json["totalMonthlySubscribtion"],
        totalOneTimeService: json["totalOneTimeService"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "totalMonthlySubscribtion": totalMonthlySubscribtion,
        "totalOneTime": totalOneTimeService,
...
class Transcation {
  ...
  User user;
  EarningUserAddress userAddress;
  ...
  factory Transcation.fromJson(Map<String, dynamic> json) => Transcation(
        ...
        userAddress: EarningUserAddress.fromJson(json["user_address"] ?? {}),
      );
...
class EarningUserAddress {
  ...
  factory EarningUserAddress.fromJson(Map<String, dynamic> json) =>
      EarningUserAddress(
        id: json["id"],
        userId: json["user_id"],
        type: json["type"],
